...
from nanobot.providers.custom_provider_stream import CustomProviderStream
...
async def main():
    # 创建provider实例
    provider = CustomProviderStream(api_base=custom_provider.api_base, api_key=custom_provider.api_key,
